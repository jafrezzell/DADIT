...
public class InitiativeBrain : MonoBehaviour
{
	...
	void Start()
	{
		...
		//_playerToggle = GameObject.Find("TOG_IsPlayer").GetComponent<Toggle>();
	...
	public void AddCharacterToEncounter()
	{
		...
		//newCharacter.IsPlayer = _playerToggle.isOn;
		...
		if (characterOrder[0] == newCharacter)
